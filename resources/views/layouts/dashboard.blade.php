                            ...
                            <div class="dropdown-list-content dropdown-list-icons">
                                ...
                                @if (session('nik') == true)
                                    ...
                                    @foreach ($notifikasi as $notif)
                                        @php
                                            $tanggapan = \App\Tanggapan::where('id_pengaduan', $notif->id)
                                                ->orderBy('id', 'desc')
                                                ->get();
                                        @endphp
                                        ...
                                        @foreach ($tanggapan as $key)
                                            @if ($key->id_petugas != null)
                                                <a href="{{ route('riwayat.show', $key->id_pengaduan) }}"
                                                    class="dropdown-item">
                                                    ...
                                                    <div class="dropdown-item-desc">
                                                        <div class="text-primary mt-2">
                                                            Tanggapan masuk dari <span
                                                                class="text-capitalize">{{ $key->petugas->username }}</span>
                                                        </div>
                                                        <br>
                                                        {{ $key->tanggapan }}
                                                        <div class="time">
                                ...
                                @if (session()->get('level') == 'petugas' || session()->get('level') == 'admin')
                                    ...
                                    @php
                                        $pengaduan = \App\Pengaduan::where('status', '0')
                                            ->orderBy('id', 'desc')
                                            ->get();
                                    @endphp
