<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post"
                    action="{{ $tanggapan->id_petugas != null || session('level') == 'admin' ? route('tanggapan.update', $tanggapan->id) : route('riwayat.update', $tanggapan->id) }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-pills" id="myTab3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#laporan" role="tab"
                            aria-controls="home" aria-selected="true">Laporan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#pelapor" role="tab"
                            aria-controls="profile" aria-selected="false">Pelapor</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade" role="tabpanel" id="pelapor" aria-labelledby="profile-tab3">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Username : <br>
                                {{ $tanggapan->pengaduan->masyarakat->username }}</li>
                            <li class="list-group-item">Nomor Telepon : <br>
                                {{ $tanggapan->pengaduan->masyarakat->telepon }}</li>
                        </ul>
                    </div>
                </div>
            </div>
