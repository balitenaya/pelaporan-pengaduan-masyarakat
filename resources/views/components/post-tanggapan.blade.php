            ...
            <div class="card-body">
                ...
                @foreach ($tanggapan as $row)
                    ...
                    <div class="mt-1">
                        ...
                        <a href="{{ route('tanggapan.edit', $row->id) }}"
                            class="btn btn-primary float-right ml-1 my-1">
                            <i class="fas fa-edit"></i>
                        </a>

                        <form method="post" action="{{ route('tanggapan.destroy', $row->id) }}"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <textarea name="tanggapan" class="form-control @error('tanggapan') is-invalid @enderror"
                                placeholder="Ketikan tanggapan anda.." {{ session('level') == 'admin' ? 'readonly' : '' }}></textarea>
                            <div class="input-group-append">
                                <button class="btn btn-primary"
                                    type="{{ session('level') == 'admin' ? 'button' : 'submit' }}">
