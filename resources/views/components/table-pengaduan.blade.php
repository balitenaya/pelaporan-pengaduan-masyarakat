                    ...
                    <form method="post" action="{{ route('pengaduan.search') }}">
                        ...
                        <div class="input-group">
                            <input type="text" name="q" class="form-control" value="{{ old('q') }}"
                                placeholder="Cari berdasarkan nomor NIK..">
                        ...
                        <tbody>
                            ...
                            @foreach ($pengaduan as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{ asset('public/files/' . $row->foto) }}" class="img-thumbnail m-1"
                                            width="130" alt="Gambar tidak ditemukan">
                                    </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form method="post" action="{{ url('dashboard/pengaduan', $row->id) }}"
                                                ...
                                                <button type="button" class="btn btn-danger mb-1"
                                                    onclick="destroy({{ $row->id }},'{{ $row->masyarakat->nama }}')">
