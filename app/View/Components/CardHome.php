...
class CardHome extends Component
{
    ...
    public function __construct()
    {
        ...
        $this->tolak = Pengaduan::where('status', 'tolak')->count();
        $this->proses = Pengaduan::where('status', 'proses')->count();
        $this->selesai = Pengaduan::where('status', 'selesai')->count();
        $this->menunggu = Pengaduan::where('status', '0')->count();
